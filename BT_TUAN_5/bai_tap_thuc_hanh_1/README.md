...
- **PageController Navigation:** Sử dụng `animateToPage`, `nextPage`, `previousPage` để điều khiển việc trượt trang bằng code (khi nhấn nút).

## 4. Hình ảnh đầu ra (Output)

|         Splash Screen         |        Onboarding 1        |         Onboarding 2         |         Onboarding 3         |
| :---------------------------: | :------------------------: | :--------------------------: | :--------------------------: |
| ![Splash Screen](image-3.png) | ![Onboarding 1](image.png) | ![Onboarding 2](image-1.png) | ![Onboarding 3](image-2.png) |
